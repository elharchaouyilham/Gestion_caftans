...
@section('content')
    <div class="bg-white py-16 border-b border-gray-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-4xl md:text-5xl font-serif font-bold text-gray-900">Accessoires de la Mariée</h1>
            <p class="mt-4 text-gray-500 max-w-2xl mx-auto text-lg">
                Complétez votre look avec nos collections d'accessoires raffinés.
                Bijoux, ceintures, couronnes et bien plus encore.
            </p>
        </div>
    </div>
            ...
            <div class="flex-1">
                        ...
                        @foreach ($products as $product)
                            <div
                                ...
                                <div class="relative overflow-hidden h-64">
                                    <img src="{{ $product->url ?? 'https://via.placeholder.com/300x400?text=Accessoire' }}"
                                        alt="{{ $product->nom }}"
                ...
                @else
                    <div class="text-center py-12">
                        ...
                        <p class="text-gray-600 text-lg">Aucun accessoire ne correspond à vos critères.</p>
                        <a href="{{ route('accessoires') }}"
